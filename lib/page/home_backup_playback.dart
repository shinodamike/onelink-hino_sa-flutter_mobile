...
import 'package:iov/widget/dropbox_general_search_string.dart';

import '../api/api.dart';
import '../localization/language/languages.dart';
import '../widget/back_ios.dart';
import '../widget/dropbox_general_search_date.dart';
import 'home_backup_playback_channel.dart';
                    ...
                    children: [
                      Container(
                        ...
                        child: DropboxGeneralSearchViewString(
                          ...
                          listData: const ["Main Stream", "Sub Stream"],
                        ),
                      ),
                      const SizedBox(
                        height: 10,
                      ...
                      isLoading2
                          ...
                          : Container(
                              ...
                              child: DropboxGeneralSearchDateView(
                                name: Languages.of(context)!.date_range,
                                onChanged: (value) {
                                  date = value.date!;
                                },
                                listData:
                ...
                child: ElevatedButton(
                  ...
                  onPressed: () {
                    if (cctvDate != null) {
                      ...
                      //     builder: (context) => HomeBackupPlaybackVideoPageFlk2(
                      //           listChannel: cctvDate!.listChannel,
                      //           date: date,
                      //           cctvVehicle: vehicleID!,
                      //       device:device
                      //         )));
                      Navigator.of(context).push(MaterialPageRoute(
                          builder: (context) => HomeBackupPlaybackChannelPage(
                              listChannel: cctvDate!.listChannel,
                              date: date,
                              cctvVehicle: vehicleID!,
                              device: device)));
