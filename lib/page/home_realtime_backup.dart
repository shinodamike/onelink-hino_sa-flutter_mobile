...
//       ..color = ColorCustom.blue.withAlpha(100);
...
//
//   Future createCustomMarkerBitmap(String title) async {
...
//     iconTest = BitmapDescriptor.fromBytes(data);
...
//   List<Marker> _markersTruck = <Marker>[];
...
//
//   updatePinRefresh() {
//     _manager.getMarkers().then((value) =>
//     {
//       // value.clear(),
//       markers.clear(),
...
//   }
//
//   // Future<Timer> eneblePin() async {
//   //   return new Timer(Duration(seconds: 1), onDoneControl);
//   // }
//   //
//   // onDoneControl() {
//   //   if (isPinFactory) {
...
//   //     for (Vehicle v in listVehicle) {
//   //       listPlace.add(
//   //           new Place(latLng: LatLng(v.gps!.lat!, v.gps!.lng!), vehicle: v));
//   //     }
//   //   }
//   //   _manager = _initClusterManager();
//   //   isLoaded = true;
...
//     circles = Set.from([
//       Circle(
//         fillColor: ColorCustom.blue.shade100,
//         strokeWidth: 0,
...
//                     onCameraIdle:
//                     _manager != null ? _manager.updateMap : null,
